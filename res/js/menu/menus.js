...
const menusTexts = {
    ...
    paused: () => {
        ...
        ctx.lineWidth = 7;
        ctx.strokeStyle = "black";
        ctx.strokeText("PAUSADO", canvas.width * 0.35, menuBg.position.y + canvas.height * 0.25);

        ctx.fillStyle = "yellow";
        ctx.fillText("PAUSADO", canvas.width * 0.35, menuBg.position.y + canvas.height * 0.25);
    },
    won: () => {
